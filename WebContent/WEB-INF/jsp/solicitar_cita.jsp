...
<body>
	<div class="container-fluid">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<h3>Citas disponibles por Asignatura</h3>
					<hr>
					<h4>Matemáticas</h4>
					<div class="form-group">
						...
						<table class="table">
							<thead>
								<tr>
									...
									<th class="info" scope="col">Profesor</th>
									<th class="info" scope="col">Correo Profesor</th>
									<th class="info" scope="col">Solicitar</th>
								</tr>
							</thead>
							<tbody>
						...
						<table class="table">
							<thead>
								<tr>
									...
									<th class="warning" scope="col">Correo Profesor</th>
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th class="success" scope="col">Profesor</th>
											<th class="success" scope="col">Correo Profesor</th>
											<th class="success" scope="col">Solicitar</th>
										</tr>
									</thead>
									<tbody>
